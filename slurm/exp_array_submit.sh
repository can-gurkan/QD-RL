...
#SBATCH --partition=long  ### PARTITION (gengpu, short: 0-4 hours, normal: 4-48 hours, long: >48 hours w10001, etc)
...
#SBATCH --time=72:00:00 ## <hh:mm:ss> how long does this need to run 
###SBATCH --mem=0
#SBATCH --mem-per-cpu=750M  ##1G ## how much RAM do you need per CPU (this effects your FairShare score so be careful to not ask for more than you need))
